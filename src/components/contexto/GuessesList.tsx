  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <div className="mb-4 text-center text-sm text-gray-600 dark:text-gray-400">
        Antal gissningar: <span className="font-bold text-gray-900 dark:text-white">{guesses.length}</span>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 flex-1">
                <div className="font-bold text-lg">{guess.rank >= FAR_RANK ? '>1000' : `#${guess.rank}`}</div>
