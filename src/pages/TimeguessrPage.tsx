      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 sm:p-12 mb-8">
        ...
        <div className="max-w-2xl mx-auto mb-8 text-center">
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg">
            Gissa både plats och tidsperiod från historiska fotografier. Analysera arkitektur, fordon och miljö för att lista ut var och när bilden togs.
          </p>
        </div>
        ...
        <section className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
          <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            Timeguessr kombinerar geografi och historia i ett fascinerande spel perfekt för studiepauser. Träna visuell analys, historisk kunskap och deduktiv logik samtidigt. Varje runda tar 2-4 minuter och ger värdefull feedback som förbättrar din förmåga att känna igen historiska epoker.
          </p>
        </section>
